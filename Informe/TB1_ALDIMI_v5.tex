...
\hypersetup{
  ...
  urlcolor   = azulref,
  citecolor  = primario,
  pdftitle   = {ALDIMI Predict - Hito 3},
...
\fancyhead[L]{%
  ...
  \color{grismed}\ ---\ Hito 3: Refinamiento y Modelado Avanzado}
...
\begin{center}
  ...
  {\LARGE\bfseries\color{primario} Trabajo Parcial\ ---\ Hito~3}\\[0.4cm]
  {\large\bfseries\color{gristexto}
    ALDIMI Predict: Refinamiento, Modelado Avanzado\\[3pt]
    e Interpretabilidad de Modelos}\\[0.5cm]
...
El sistema ALDIMI Predict en su estado actual est\'a listo para una evaluaci\'on piloto con datos reales, pendiente de la integraci\'on con el m\'odulo de IA del curso hermano en el Hito~4.
